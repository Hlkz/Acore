...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_INS_CHAR_SPELL,
    CHAR_DEL_CHAR_SAVE_STATS,
    CHAR_INS_CHAR_SAVE_STATS,
    ...
    CHAR_UPD_ARENA_WIN,
    CHAR_UPD_PVP_POINTS,
    CHAR_SEL_PLA_BY_RANK,
    CHAR_UPD_RESET_WIN_DAY,
    CHAR_SEL_PVP_ALL,
    CHAR_SEL_TOP_RANK,
    CHAR_SEL_RANKS_INFO,

    CHAR_UPD_FACTION_RELATIONS,
    CHAR_UPD_FACTION_RELATION,
    CHAR_INS_FACTION_RELATION,
    CHAR_UPD_FACTION_GUILD_RELATIONS,
    CHAR_UPD_FACTION_GUILD_RELATION,
    CHAR_INS_FACTION_GUILD_RELATION,
    CHAR_INS_GUILD_RELATION,
    CHAR_UPD_GUILD_RELATION,
    CHAR_DEL_GUILD_RELATION,
    CHAR_DEL_GUILD_RELATIONS,
    CHAR_DEL_GUILD_FACTION_RELATIONS,

    CHAR_INS_CHAR_STATS,
    CHAR_INS_CHAR_STATS_INIT,
    CHAR_SEL_CHAR_STATS,
    CHAR_DEL_CHAR_STATS,
    CHAR_UPD_CHAR_STAT_STRENGTH,
    CHAR_UPD_CHAR_STAT_AGILITY,
    CHAR_UPD_CHAR_STAT_STAMINA,
    CHAR_UPD_CHAR_STAT_INTELLECT,
    CHAR_UPD_CHAR_STAT_SPIRIT,
    CHAR_UPD_CHAR_STAT_HEALTH,
    CHAR_UPD_CHAR_STAT_MANA,
    CHAR_UPD_CHAR_STAT_RAGE,
    CHAR_UPD_CHAR_STAT_FOCUS,
    CHAR_UPD_CHAR_STAT_ENERGY,
    CHAR_UPD_CHAR_STAT_HAPPINESS,
    CHAR_UPD_CHAR_STAT_RUNE,
    CHAR_UPD_CHAR_STAT_RUNIC_POWER,
    CHAR_UPD_CHAR_STAT_ARMOR,
    CHAR_UPD_CHAR_STAT_RESISTANCE_HOLY,
    CHAR_UPD_CHAR_STAT_RESISTANCE_FIRE,
    CHAR_UPD_CHAR_STAT_RESISTANCE_NATURE,
    CHAR_UPD_CHAR_STAT_RESISTANCE_FROST,
    CHAR_UPD_CHAR_STAT_RESISTANCE_SHADOW,
    CHAR_UPD_CHAR_STAT_RESISTANCE_ARCANE,
    CHAR_UPD_CHAR_STAT_ATTACK_POWER,
    CHAR_UPD_CHAR_STAT_ATTACK_POWER_RANGED,
    CHAR_UPD_CHAR_STAT_DAMAGE_MAINHAND,
    CHAR_UPD_CHAR_STAT_DAMAGE_OFFHAND,
    CHAR_UPD_CHAR_STAT_DAMAGE_RANGED,
