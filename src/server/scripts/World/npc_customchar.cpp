    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        switch (action)
        {
            ...
            case 2:
                ...
                creature->Whisper("Un changement de nom et d'apparence vous sera proposé à votre prochaine reconnexion.", LANG_UNIVERSAL, player);
                break;
            case 3:
                player->CLOSE_GOSSIP_MENU();
                player->SetAtLoginFlag(AT_LOGIN_CHANGE_RACE);
                player->PlayDirectSound(13838);
                creature->Whisper("Un changement de race vous sera proposé à votre prochaine reconnexion.", LANG_UNIVERSAL, player);
                break;
            case 4:
            ...
            case 5:
                ...
                player->PlayDirectSound(13838);
                creature->Whisper("Un changement de faction vous sera proposé à votre prochaine reconnexion.", LANG_UNIVERSAL, player);
                break;
        }
        return true;
    }
