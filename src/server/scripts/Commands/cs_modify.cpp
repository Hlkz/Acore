...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        ...
        {
            { "morph",          SEC_ANIMATOR,       false, &HandleModifyMorphCommand,          "", NULL },
            { "demorph",        SEC_ANIMATOR,       false, &HandleDeMorphCommand,              "", NULL },
    ...
    static bool HandleModifyRepCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            handler->PSendSysMessage(LANG_COMMAND_FACTION_NOREP_ERROR, factionEntry->name[handler->GetSessionDbcLocale()].c_str(), factionId);
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        handler->PSendSysMessage(LANG_COMMAND_MODIFY_REP, factionEntry->name[handler->GetSessionDbcLocale()].c_str(), factionId,
