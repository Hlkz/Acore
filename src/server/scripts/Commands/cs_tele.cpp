...
public:
    ...
    ChatCommand* GetCommands() const
    {
        static ChatCommand teleCommandTable[] =
        {
            ...
            { "name",           SEC_ANIMATOR,      true,  &HandleTeleNameCommand,            "", NULL },
            { "group",          SEC_ANIMATOR,      false, &HandleTeleGroupCommand,           "", NULL },
            { "",               SEC_ANIMATOR,      false, &HandleTeleCommand,                "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "tele",           SEC_ANIMATOR,      false, NULL,                   "", teleCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
