...
public:
    ...
    ChatCommand* GetCommands() const
    {
        static ChatCommand reloadAllCommandTable[] =
        {
            ...
            { "loot",       SEC_GAMEMASTER,     true,  &HandleReloadAllLootCommand,       "", NULL },
            { "npc",        SEC_GAMEMASTER,     true,  &HandleReloadAllNpcCommand,        "", NULL },
            { "quest",      SEC_GAMEMASTER,     true,  &HandleReloadAllQuestCommand,      "", NULL },
            { "scripts",    SEC_GAMEMASTER,     true,  &HandleReloadAllScriptsCommand,    "", NULL },
            { "spell",      SEC_GAMEMASTER,     true,  &HandleReloadAllSpellCommand,      "", NULL },
            { "",           SEC_GAMEMASTER,     true,  &HandleReloadAllCommand,           "", NULL },
            { NULL,         0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand reloadCommandTable[] =
        {
            { "auctions",                     SEC_GAMEMASTER,    true,  &HandleReloadAuctionsCommand,                   "", NULL },
            { "access_requirement",           SEC_GAMEMASTER,    true,  &HandleReloadAccessRequirementCommand,          "", NULL },
            { "achievement_criteria_data",    SEC_GAMEMASTER,    true,  &HandleReloadAchievementCriteriaDataCommand,    "", NULL },
            { "achievement_reward",           SEC_GAMEMASTER,    true,  &HandleReloadAchievementRewardCommand,          "", NULL },
            { "all",                          SEC_GAMEMASTER,    true,  NULL,                          "", reloadAllCommandTable },
            { "areatrigger_involvedrelation", SEC_GAMEMASTER,    true,  &HandleReloadQuestAreaTriggersCommand,          "", NULL },
            ...
            { "creature_involvedrelation",    SEC_GAMEMASTER,    true,  &HandleReloadCreatureQuestInvRelationsCommand,  "", NULL },
            ...
            { "creature_questrelation",       SEC_GAMEMASTER,    true,  &HandleReloadCreatureQuestRelationsCommand,     "", NULL },
            ...
            { "fishing_loot_template",        SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesFishingCommand,       "", NULL },
            { "game_graveyard_zone",          SEC_GAMEMASTER,    true,  &HandleReloadGameGraveyardZoneCommand,          "", NULL },
            { "game_tele",                    SEC_GAMEMASTER,    true,  &HandleReloadGameTeleCommand,                   "", NULL },
            { "gameobject_involvedrelation",  SEC_GAMEMASTER,    true,  &HandleReloadGOQuestInvRelationsCommand,        "", NULL },
            { "gameobject_loot_template",     SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesGameobjectCommand,    "", NULL },
            { "gameobject_questrelation",     SEC_GAMEMASTER,    true,  &HandleReloadGOQuestRelationsCommand,           "", NULL },
            { "gm_tickets",                   SEC_GAMEMASTER,    true,  &HandleReloadGMTicketsCommand,                  "", NULL },
            { "gossip_menu",                  SEC_GAMEMASTER,    true,  &HandleReloadGossipMenuCommand,                 "", NULL },
            { "gossip_menu_option",           SEC_GAMEMASTER,    true,  &HandleReloadGossipMenuOptionCommand,           "", NULL },
            { "item_enchantment_template",    SEC_GAMEMASTER,    true,  &HandleReloadItemEnchantementsCommand,          "", NULL },
            { "item_loot_template",           SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesItemCommand,          "", NULL },
            { "item_set_names",               SEC_GAMEMASTER,    true,  &HandleReloadItemSetNamesCommand,               "", NULL },
            { "lfg_dungeon_rewards",          SEC_GAMEMASTER,    true,  &HandleReloadLfgRewardsCommand,                 "", NULL },
            { "locales_achievement_reward",   SEC_GAMEMASTER,    true,  &HandleReloadLocalesAchievementRewardCommand,   "", NULL },
            { "locales_creature",             SEC_GAMEMASTER,    true,  &HandleReloadLocalesCreatureCommand,            "", NULL },
            { "locales_creature_text",        SEC_GAMEMASTER,    true,  &HandleReloadLocalesCreatureTextCommand,        "", NULL },
            { "locales_gameobject",           SEC_GAMEMASTER,    true,  &HandleReloadLocalesGameobjectCommand,          "", NULL },
            { "locales_gossip_menu_option",   SEC_GAMEMASTER,    true,  &HandleReloadLocalesGossipMenuOptionCommand,    "", NULL },
            { "locales_item",                 SEC_GAMEMASTER,    true,  &HandleReloadLocalesItemCommand,                "", NULL },
            { "locales_item_set_name",        SEC_GAMEMASTER,    true,  &HandleReloadLocalesItemSetNameCommand,         "", NULL },
            { "locales_npc_text",             SEC_GAMEMASTER,    true,  &HandleReloadLocalesNpcTextCommand,             "", NULL },
            { "locales_page_text",            SEC_GAMEMASTER,    true,  &HandleReloadLocalesPageTextCommand,            "", NULL },
            { "locales_points_of_interest",   SEC_GAMEMASTER,    true,  &HandleReloadLocalesPointsOfInterestCommand,    "", NULL },
            { "locales_quest",                SEC_GAMEMASTER,    true,  &HandleReloadLocalesQuestCommand,               "", NULL },
            { "mail_level_reward",            SEC_GAMEMASTER,    true,  &HandleReloadMailLevelRewardCommand,            "", NULL },
            { "mail_loot_template",           SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesMailCommand,          "", NULL },
            { "milling_loot_template",        SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesMillingCommand,       "", NULL },
            { "npc_spellclick_spells",        SEC_GAMEMASTER,    true,  &HandleReloadSpellClickSpellsCommand,           "", NULL},
            { "npc_trainer",                  SEC_GAMEMASTER,    true,  &HandleReloadNpcTrainerCommand,                 "", NULL },
            { "npc_vendor",                   SEC_GAMEMASTER,    true,  &HandleReloadNpcVendorCommand,                  "", NULL },
            { "page_text",                    SEC_GAMEMASTER,    true,  &HandleReloadPageTextsCommand,                  "", NULL },
            { "pickpocketing_loot_template",  SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesPickpocketingCommand, "", NULL},
            { "points_of_interest",           SEC_GAMEMASTER,    true,  &HandleReloadPointsOfInterestCommand,           "", NULL },
            { "prospecting_loot_template",    SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesProspectingCommand,   "", NULL },
            { "quest_poi",                    SEC_GAMEMASTER,    true,  &HandleReloadQuestPOICommand,                   "", NULL },
            { "quest_template",               SEC_GAMEMASTER,    true,  &HandleReloadQuestTemplateCommand,              "", NULL },
            { "reference_loot_template",      SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesReferenceCommand,     "", NULL },
            { "reserved_name",                SEC_GAMEMASTER,    true,  &HandleReloadReservedNameCommand,               "", NULL },
            { "reputation_reward_rate",       SEC_GAMEMASTER,    true,  &HandleReloadReputationRewardRateCommand,       "", NULL },
            { "reputation_spillover_template", SEC_GAMEMASTER,    true,  &HandleReloadReputationRewardRateCommand,       "", NULL },
            { "skill_discovery_template",     SEC_GAMEMASTER,    true,  &HandleReloadSkillDiscoveryTemplateCommand,     "", NULL },
            { "skill_extra_item_template",    SEC_GAMEMASTER,    true,  &HandleReloadSkillExtraItemTemplateCommand,     "", NULL },
            { "skill_fishing_base_level",     SEC_GAMEMASTER,    true,  &HandleReloadSkillFishingBaseLevelCommand,      "", NULL },
            { "skinning_loot_template",       SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesSkinningCommand,      "", NULL },
            { "smart_scripts",                SEC_GAMEMASTER,    true,  &HandleReloadSmartScripts,                      "", NULL },
            { "spell_required",               SEC_GAMEMASTER,    true,  &HandleReloadSpellRequiredCommand,              "", NULL },
            { "spell_area",                   SEC_GAMEMASTER,    true,  &HandleReloadSpellAreaCommand,                  "", NULL },
            { "spell_bonus_data",             SEC_GAMEMASTER,    true,  &HandleReloadSpellBonusesCommand,               "", NULL },
            { "spell_group",                  SEC_GAMEMASTER,    true,  &HandleReloadSpellGroupsCommand,                "", NULL },
            { "spell_learn_spell",            SEC_GAMEMASTER,    true,  &HandleReloadSpellLearnSpellCommand,            "", NULL },
            { "spell_loot_template",          SEC_GAMEMASTER,    true,  &HandleReloadLootTemplatesSpellCommand,         "", NULL },
            { "spell_linked_spell",           SEC_GAMEMASTER,    true,  &HandleReloadSpellLinkedSpellCommand,           "", NULL },
            { "spell_pet_auras",              SEC_GAMEMASTER,    true,  &HandleReloadSpellPetAurasCommand,              "", NULL },
            { "spell_proc_event",             SEC_GAMEMASTER,    true,  &HandleReloadSpellProcEventCommand,             "", NULL },
            { "spell_proc",                   SEC_GAMEMASTER,    true,  &HandleReloadSpellProcsCommand,                 "", NULL },
            { "spell_scripts",                SEC_GAMEMASTER,    true,  &HandleReloadSpellScriptsCommand,               "", NULL },
            ...
            { "waypoint_data",                SEC_GAMEMASTER,    true,  &HandleReloadWpCommand,                         "", NULL },
            { "vehicle_accessory",            SEC_GAMEMASTER,    true,  &HandleReloadVehicleAccessoryCommand,           "", NULL },
            { "vehicle_template_accessory",   SEC_GAMEMASTER,    true,  &HandleReloadVehicleTemplateAccessoryCommand,   "", NULL },
            { NULL,                           0,                 false, NULL,                                           "", NULL }
        };
