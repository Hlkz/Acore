...
class BattlegroundQueue
{
    public:
        ...
        bool FillXPlayersToBG(BattlegroundBracketId bracket_id, Battleground* bg, bool start = false);  // crossfaction
        bool CheckCrossFactionMatch(BattlegroundBracketId bracket_id, Battleground* bg);                // crossfaction
        ...
        typedef std::multimap<int32, GroupQueueInfo*> QueuedGroupMap;                                   // crossfaction
        int32 PreAddPlayers(QueuedGroupMap m_PreGroupMap, int32 MaxAdd, uint32 MaxInTeam);              // crossfaction
