...
void Spell::EffectLearnSkill(SpellEffIndex effIndex)
{
    ...
    SkillTiersEntry const* tier = sDBCMgr->GetSkillTiersEntry(rcEntry->SkillTier);
    if (!tier)
        return;
...
void Spell::EffectGameObjectDamage(SpellEffIndex /*effIndex*/)
{
    ...
    FactionTemplateEntry const* targetFaction = sDBCMgr->GetFactionTemplateEntry(gameObjTarget->GetUInt32Value(GAMEOBJECT_FACTION));
