...
class PlayerTaxi
{
    public:
        ...
        ~PlayerTaxi() { }
        // Nodes
        void InitTaxiNodesForLevel(uint32 team, uint32 race, uint32 chrClass, uint8 level);
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        bool IsInSameGuildWith(Player const* p) const;
