...
class Unit : public WorldObject
{
    public:
        ...
        uint8 getRace(bool real = false) const;
        ...
        uint16 GetMaxSkillValueForLevel(Unit const* target = NULL) const { return 100; /*return (target ? getLevelForTarget(target) : getLevel()) * 5;*/ }
        ...
        // stat system
        bool HandleStatModifier(uint16 unitMod, UnitModifierType modifierType, float amount, bool apply);
        void SetModifierValue(UnitMods unitMod, UnitModifierType modifierType, float value) { m_auraModifiersGroup[unitMod][modifierType] = value; }
        float GetModifierValue(UnitMods unitMod, UnitModifierType modifierType) const;
        float GetTotalStatValue(Stats stat) const;
        float GetTotalAuraModValue(UnitMods unitMod) const;
        SpellSchools GetSpellSchoolByAuraGroup(uint16 unitMod) const;
        Stats GetStatByAuraGroup(uint16 unitMod) const;
        Powers GetPowerTypeByAuraGroup(uint16 unitMod) const;
        ...
        float CalcSpellResistance(Unit* victim, SpellSchoolMask schoolMask, SpellInfo const* spellInfo) const;
