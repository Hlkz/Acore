...
CREATE TABLE `chrracesdbc` (
  ...
  `ClientPrefix` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
  ...
  `NameFemale` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `NameFemale_loc2` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `NameMale` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `NameMale_loc2` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `FacialHairCustomization1` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `FacialHairCustomization2` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `HairCustomization` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
