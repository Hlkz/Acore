...
CREATE TABLE `animationdata` (
  ...
  `Weaponflags` int(10) NOT NULL DEFAULT '0',
  `Bodyflags` int(10) NOT NULL DEFAULT '0',
  `Flags` int(10) NOT NULL DEFAULT '0',
  `Fallback` int(10) NOT NULL DEFAULT '0',
  `BehaviourId` int(10) NOT NULL DEFAULT '0',
  `BehaviorTier` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id` (`Id`)
...
--
-- Dumping data for table `animationdata`
--

LOCK TABLES `animationdata` WRITE;
/*!40000 ALTER TABLE `animationdata` DISABLE KEYS */;
/*!40000 ALTER TABLE `animationdata` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Records of `animationdata`
--
